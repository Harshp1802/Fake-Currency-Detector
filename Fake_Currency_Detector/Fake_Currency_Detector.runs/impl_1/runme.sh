...
HD_PWD='C:/Users/HARSHIT/Desktop/Harsh DS Project/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Store_Data.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Store_Data.tcl -notrace
