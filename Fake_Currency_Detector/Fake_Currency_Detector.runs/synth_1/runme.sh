...
HD_PWD='C:/Users/HARSHIT/Desktop/Harsh DS Project/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Store_Data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Store_Data.tcl
